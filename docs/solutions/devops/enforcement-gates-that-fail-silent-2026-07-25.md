...
- **Sibling docs:** [Validator detection vs acceptance](../testing-patterns/validator-detection-vs-acceptance-2026-07-25.md) — the identical principle for tools you *consume* rather than author. That doc says: never trust a zero without a negative control. This one says: when you wrote the gate yourself, you also own proving it can fail.
